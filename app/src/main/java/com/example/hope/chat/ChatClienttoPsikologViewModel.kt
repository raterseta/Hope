...
class ChatClienttoPsikologViewModel : ViewModel() {
    ...
    suspend fun sendMessage(chatId: String, message: String, currentUserID: String , currentUserAvatarID: Int , currentUsername: String ,activePsikologID: String): Boolean {
        val userId = "$currentUserID"  // Ganti dengan logic untuk mendapatkan user ID yang valid
        val userAvatarId = "$currentUserAvatarID"
        val userName = "$currentUsername"
        val psikologID = activePsikologID


        val messageData = hashMapOf(
            "fromClientId" to userId,
            "fromClientAvatarId" to userAvatarId,
            "fromClientName" to userName,
            "toPsikologID" to psikologID,
            "message" to message,
